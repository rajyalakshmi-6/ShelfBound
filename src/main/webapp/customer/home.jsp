...
<body>
	...
	<div class="navbar">
		...
		<div class="nav-links">
			<a href="<%= request.getContextPath() %>/home">Home</a> <a
				...
				href="<%= request.getContextPath() %>/about">About</a> <a
				href="<%= request.getContextPath() %>/contact">Contact</a>
        ...
        %>
			<span class="welcome-user">Welcome, <%= username %></span> <a
				href="<%= request.getContextPath() %>/logout" class="btn-logout">Logout</a>
			<%
            }
        %>
	...
	<div class="hero">
		<video autoplay loop muted playsinline class="hero-video">
			<source
				src="<%= request.getContextPath() %>/assets/videos/hero-bg.mp4"
				type="video/mp4">
		</video>
...
BooksServlet receives "search" parameter
and searches matching books.
=========================================
-->

			<form class="hero-search"
				action="<%=request.getContextPath()%>/books" method="get"
	...
	<div class="section">
		...
		<div class="section-header">
			<h2>New Arrivals</h2>
			<a href="<%= request.getContextPath() %>/books" class="view-all-link">View
				All &rarr;</a>
		</div>
